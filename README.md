...
| Component | Version |
|---|---|
| DeepSeek Harness | `0.1.2-rc.1` (peer dependencies pinned). Verified 2026-09-06 against the dsh-v0.1.3-alpha.1 master checkout (full gate chain + profile install smoke). |
