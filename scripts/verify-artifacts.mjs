...
// shipped output and against a tarball missing the bundle patch or the
// bundled skill.
...
if (typeof index.apply !== 'function' || index.name !== 'dsh-fund-research') {
...
console.log('artifacts OK: syntax + ESM import + plugin face + bundle patch + skill present')
