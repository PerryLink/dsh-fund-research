#!/usr/bin/env node
/**
 * Release automation for dsh-fund-research.
 *
 ...
 *      tag (message: `dsh-fund-research v<version>`).
 *
 ...
 *
 * @module dsh-fund-research/scripts/release
 */
...
git('tag', '-a', `v${version}`, '-m', `dsh-fund-research v${version}`)
