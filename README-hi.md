...
| घटक | संस्करण |
|---|---|
| DeepSeek Harness | `dsh-v0.1.5-rc.2` (peer निर्भरताएँ पिन की गईं; `0.1.2-rc.1` लाइन अभी भी समर्थित)। 2026-09-11 को dsh-v0.1.5-rc.2 master checkout के विरुद्ध सत्यापित (पूर्ण गेट श्रृंखला); प्रोफ़ाइल इंस्टॉल स्मोक मासिक Compat workflow में चलता है। |
...
समान इंजीनियरिंग आधार साझा करने वाले स्टैंडअलोन DeepSeek Harness प्लगइनों के परिवार का हिस्सा: पिन किए गए 0.1.5-rc.2 peers, ज़ोर-विफल Schemastery config, पाँच-भाषा READMEs, और वास्तविक-seam vitest कवरेज।
