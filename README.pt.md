...
| Componente | Versão |
|---|---|
| DeepSeek Harness | `0.1.2-rc.1` (peer dependencies fixadas). Verificado em 2026-09-06 contra o checkout master dsh-v0.1.3-alpha.1 (cadeia completa de gates + smoke de instalação de perfil). |
