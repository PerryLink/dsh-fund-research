...
| घटक | संस्करण |
|---|---|
| DeepSeek Harness | `dsh-v0.1.3-alpha.1` (peer निर्भरताएँ पिन की गईं)। 2026-09-06 को dsh-v0.1.3-alpha.1 master checkout के विरुद्ध सत्यापित (पूर्ण गेट श्रृंखला + प्रोफ़ाइल इंस्टॉल स्मोक)। |
