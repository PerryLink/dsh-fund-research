...
| घटक | संस्करण |
|---|---|
| DeepSeek Harness | `dsh-v0.1.5-alpha.1` (peer निर्भरताएँ पिन की गईं; `0.1.2-rc.1` लाइन अभी भी समर्थित)। 2026-09-09 को dsh-v0.1.5-alpha.1 master checkout के विरुद्ध सत्यापित (पूर्ण गेट श्रृंखला); प्रोफ़ाइल इंस्टॉल स्मोक मासिक Compat workflow में चलता है। |
...
परीक्षण 0.1.5-alpha.1 peers के वास्तविक `Context`/`SessionStore`/`ToolRuntime`/`LocalJobRegistry`/स्टोरेज seam का उपयोग करते हैं; नेटवर्क केवल fetch सीमा पर सहेजे गए वास्तविक-प्रतिक्रिया फिक्स्चर (`fixtures/`, फंड 161725) द्वारा प्रतिस्थापित होता है। `.tmp/` के कलेक्टर स्क्रिप्ट से फिक्स्चर ताज़ा करें।
...
समान इंजीनियरिंग आधार साझा करने वाले स्टैंडअलोन DeepSeek Harness प्लगइनों के परिवार का हिस्सा: पिन किए गए 0.1.5-alpha.1 peers, ज़ोर-विफल Schemastery config, पाँच-भाषा READMEs, और वास्तविक-seam vitest कवरेज।
