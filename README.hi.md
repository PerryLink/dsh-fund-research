...
| घटक | संस्करण |
|---|---|
| DeepSeek Harness | `0.1.1-rc.2` (peer निर्भरताएँ पिन की गईं) |
...
- सत्र इवेंट केवल-लॉग ऑडिट रिकॉर्ड हैं; पिन किए गए 0.1.1-rc.2 peers कोई `ignorable` एनवलप प्रदान नहीं करते, इसलिए *इस* प्लगइन के बिना किसी build द्वारा पुनर्स्थापित सत्र उन लॉग पंक्तियों को अस्वीकार करता है — इस परिवार के अन्य शोध प्लगइनों द्वारा स्वीकृत वही व्यापार-बंद।
...
परीक्षण 0.1.1-rc.2 peers के वास्तविक `Context`/`SessionStore`/`ToolRuntime`/`LocalJobRegistry`/स्टोरेज seam का उपयोग करते हैं; नेटवर्क केवल fetch सीमा पर सहेजे गए वास्तविक-प्रतिक्रिया फिक्स्चर (`fixtures/`, फंड 161725) द्वारा प्रतिस्थापित होता है। `.tmp/` के कलेक्टर स्क्रिप्ट से फिक्स्चर ताज़ा करें।
...
समान इंजीनियरिंग आधार साझा करने वाले स्टैंडअलोन DeepSeek Harness प्लगइनों के परिवार का हिस्सा: पिन किए गए 0.1.1-rc.2 peers, ज़ोर-विफल Schemastery config, पाँच-भाषा READMEs, और वास्तविक-seam vitest कवरेज।
